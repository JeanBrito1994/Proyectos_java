 ...
 * @author jpbri
 */
public class VistaAtencionesDetalle extends javax.swing.JFrame {
    /**
     * Creates new form VistaAtenciones
     */
    public VistaAtencionesDetalle() {
        initComponents();
        ...
        try{
            ...
            listaAtencion = lg_doc.listarAtencionesDetalle(VistaAtenciones.cod);
            
            DefaultTableModel tablaModelo = (DefaultTableModel)tbl_atencion_detalle.getModel();
    ...
    private void initComponents() {
        ...
        btn_generar_boleta = new javax.swing.JButton();
        ...
        tbl_atencion_detalle.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Codigo Reserva", "Fecha de Reserva", "Servicio Entregado", "Precio Servicio"
            }
        ) {
        ...
        btn_generar_factura.setBackground(new java.awt.Color(54, 49, 68));
        btn_generar_factura.setForeground(new java.awt.Color(255, 255, 255));
        btn_generar_factura.setText("Registrar Factura");
        ...
        btn_generar_boleta.setBackground(new java.awt.Color(54, 49, 68));
        btn_generar_boleta.setForeground(new java.awt.Color(255, 255, 255));
        btn_generar_boleta.setText("Registrar Boleta");
        ...
        btn_quitar_servicio.setBackground(new java.awt.Color(236, 104, 104));
        btn_quitar_servicio.setText("Quitar Servicio");
        btn_quitar_servicio.setActionCommand("");
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                        .addGap(321, 321, 321)
                        .addComponent(btn_generar_boleta, javax.swing.GroupLayout.PREFERRED_SIZE, 132, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(btn_generar_factura, javax.swing.GroupLayout.PREFERRED_SIZE, 132, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                        .addGap(39, 39, 39)
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(btn_quitar_servicio, javax.swing.GroupLayout.PREFERRED_SIZE, 147, javax.swing.GroupLayout.PREFERRED_SIZE))
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(btn_quitar_servicio, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(18, 18, 18)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(btn_generar_boleta, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(btn_generar_factura, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap(37, Short.MAX_VALUE))
        );

        label2.setFont(new java.awt.Font("Dialog", 0, 24)); // NOI18N
        label2.setPreferredSize(new java.awt.Dimension(100, 20));
        label2.setText("Detalle de Atención");
    ...
    private void btn_agregar_servicioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_agregar_servicioActionPerformed
        VistaAgregarServicio menu = new VistaAgregarServicio();
    ...
    private void btn_quitar_servicioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_quitar_servicioActionPerformed
        ...
        try{
            if(tbl_atencion_detalle.getSelectedRow()==-1){
                JOptionPane.showMessageDialog(rootPane, "Seleccione una opción");
            }else{
                
                
            int indice = tbl_atencion_detalle.getSelectedRow();
            String nombre = tbl_atencion_detalle.getValueAt(indice, 2).toString();
            lg_servicio.eliminarServicioABOLFac(nombre);
            }
        
            
        
        JOptionPane.showMessageDialog(rootPane, "Servicio Eliminado Correctamente!!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VistaAtencionesDetalle.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VistaAtencionesDetalle().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JButton btn_generar_boleta;
